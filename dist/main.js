...
const controlShowProject = function (title) {
  ...
  const tasksToShow = _model__WEBPACK_IMPORTED_MODULE_0__.state.tasks.filter((el) => el.project === project);

  console.log(tasksToShow);

  if (!tasksToShow || tasksToShow.length < 1) return;

  _views_projectView__WEBPACK_IMPORTED_MODULE_10__.default.render(tasksToShow);
};
...
const init = function () {
  ...
  _views_projectView__WEBPACK_IMPORTED_MODULE_10__.default.addHandlerShowProject(controlShowProject);
